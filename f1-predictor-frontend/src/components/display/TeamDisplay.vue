...
<template>
  <div v-if="userTeams && comparativeTeam"
    ...
    <div class="tw-flex tw-flex-row tw-py-1 tw-px-2 tw-border-b-1 tw-border-primary-light">
      <select id="comparativeTeam" @change="updateComparativeTeam"
              class="tw-appearance-none tw-text-lg tw-border-0 tw-bg-primary-light tw-bg-opacity-0 tw-text-f1-white">
    ...
    <div class="tw-h-full tw-flex tw-flex-col tw-gap-2 tw-bg-primary-dark tw-rounded-b-lg">
      <div class="tw-w-full tw-flex tw-px-2 tw-pt-1">
        <div class="tw-mr-auto">£{{ comparativeTeam.costCap }}m</div>
        <div>{{ comparativeTeam.freeTransfers }} Transfers</div>
      </div>
